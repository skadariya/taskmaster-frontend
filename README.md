...
This application connects the task master back end to the users with the help of amazon AWS amplify console to see the list of all tasks available in the database.
